...
from .views import RegisterView, SendVerificationEmailView, VerifyEmailView, RequestPasswordResetView, PasswordResetConfirmView, AuthorView, RegisterAuthorView, LogoutView, LoginView, ProfileView
